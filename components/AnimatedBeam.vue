  ...
  >
    ...
    <defs>
      <linearGradient
        ...
        x1="0%"
        :x2="props.horizontal ? '0%' : '100%'"
        y1="0%"
        :y2="props.horizontal ? '100%' : '0%'"
      >
        ...
        <animate
          :attributeName="props.horizontal ? 'y1' : 'x1'"
          :values="props.horizontal ? y1 : x1"
          :dur="`${duration}s`"
          keyTimes="0; 1"
        ...
        />
        <animate
          :attributeName="props.horizontal ? 'y2' : 'x2'"
          :values="props.horizontal ? y2 : x2"
          :dur="`${duration}s`"
          keyTimes="0; 1"
          keySplines="0.16 1 0.3 1"
          calcMode="spline"
