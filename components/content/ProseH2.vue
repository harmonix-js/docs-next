...
<template>
  <h2
    :id="id"
    class="relative flex border-t border-dashed border-t-neutral-200 pt-10 scroll-mt-3 text-2xl font-semibold mt-12 mb-6 leading-normal"
  >
    <NuxtLink :to="`#${id}`" class="group/h2">
      <div
