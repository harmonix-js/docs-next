...
<template>
  <div
    ...
    :class="
      cn(
        'relative grid w-fit rounded-[--border-radius] bg-white text-neutral-900 glow-border',
        $props.class
      )
    "
  >
    <div
      ...
      :class="
        cn(
          `z-20 glow-border before:absolute before:inset-0 before:aspect-square before:size-full before:rounded-[--border-radius] before:bg-[length:300%_300%] before:p-[--border-width] before:opacity-50 before:will-change-[background-position] before:content-['']`,
